...
const Button = ({ children, onClick, variant, className = "", disabled = false }: ButtonProps) => (
  <button className={`${variantMap[variant]} ${className}`} onClick={onClick} disabled={disabled}>
    {children}
  </button>
)
