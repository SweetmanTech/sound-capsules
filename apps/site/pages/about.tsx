      ...
      <section className="max-w-xl mx-auto space-y-12">
        <div className="space-y-1">
          ...
          <p className="text-black font-size-text line-height-1-5">
            Sound Capsule’s are a collection of 10,000 NFTs on Base chain that can be used to curate
            NFT playlists. Each player is has a token bound account (smart wallet) allowing it to
            own other NFTs.
          </p>
        </div>
        <div className="space-y-1">
          ...
          <p className="text-black font-size-text line-height-1-5">
            To add music you must transfer audio NFTs to the Sound Capsule’s smart wallet. The
            easiest way is through the manage page. Each transfer in, or transfer out requires and
            onchain transaction. To prevent spam, only the wallet who owns the Sound Capsule NFT can
        ...
        <div className="space-y-1">
          ...
          <p className="text-black font-size-text line-height-1-5">
            Each Sound Capsule can be sold as a playlist. All contents will be sold with the NFT if
            sold or transferred to another wallet.
          </p>
        </div>
