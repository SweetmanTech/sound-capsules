...
function Logo() {
  ...
  return (
    <Link href="/" className="flex items-center justify-center h-[72px] w-[72px]">
      <svg
        role="img"
        aria-label="Logo"
        viewBox="0 0 72 72"
        ...
        className={`rounded-2xl h-[72px] w-[72px] ${isActive ? "" : "border border-gray-200"}`}
      >
        <rect width="72" height="72" rx="20" className={isActive ? "fill-black" : "fill-white"} />
        <path
