import { mainnet, optimism, optimismSepolia, sepolia, polygon, polygonMumbai } from "viem/chains"
...
const getMusicNfts = async (address: string) => {
  ...
  const combinedNFTs = [
    ...
    ...addChainId(opNfts.ownedNfts, IS_TESTNET ? optimismSepolia.id : optimism.id),
    ...addChainId(nfts.ownedNfts, IS_TESTNET ? sepolia.id : mainnet.id),
    ...addChainId(polygonNfts.ownedNfts, IS_TESTNET ? polygonMumbai.id : polygon.id),
  ]
