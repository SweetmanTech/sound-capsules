...
import { CAPSULE_DROP_ADDRESS, IS_TESTNET, PRESALE_PRICE, ZORA_FEE } from "@/lib/consts"

const getZoraMintPresaleCall = (mintQuantity: number) => {
  const totalPrice = BigNumber.from(PRESALE_PRICE).add(ZORA_FEE).mul(mintQuantity).toString()
